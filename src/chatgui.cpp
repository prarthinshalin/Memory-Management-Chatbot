    ...
    : wxScrolledWindow(parent, id)
{
    ...
    //STUDENT: A ChatLogic object has been initialized on the heap, the pointer (which is on the stack) pointed to the ChatLogic class on the heap has been assigned to the member variable _chatLogic
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    /*STUDENT: There is no need for explicit deallocation of the ChatLogic object on the heap since _chatLogic 
    has now been implemented as a unique_ptr. As soon as the program leaves the scope, the unique_ptr automatically
    deallocated the memory on the heap.*/
    //delete _chatLogic;
